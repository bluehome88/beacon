...
<link href='http://fonts.googleapis.com/css?family=Open+Sans:400,800,300,600,700&subset=latin,latin-ext' rel='stylesheet' type='text/css'>
<?php 
$page_id = $post->ID;
...
<link href="<?php echo get_template_directory_uri() ?>/css/landing-page.css" rel="stylesheet" type="text/css"/>
<script>
function sendMail() 
{
...
var photos = [ 
		...
		for( $i=0;$i<count($photo);$i++)
		{
			...
			?>
			{
				...
				"secondline" : "<?php echo $secondaryMessage; ?>"
			}
...
<body class="landing-page">
	<div class="header-wrap">
		<div id="header_inner">
			<div class="head_left">
				<div class="logo"> <a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo get_template_directory_uri() ?>/images/landing-logo.png" alt="logo" /></a> </div>
			</div>   
			...
			<!--  <div class="head_top_right_nev"> <a href="#">Login</a></div>--> 
             <div class="head_top_right_nev about_you_logo"> <a href="https://portal.beacon.co.tt/Customer"><img src="http://beta2-beacon.simplyintense.com/wp-content/themes/beacon/images/Beacon_about_you_c.png" alt="About you" /></a></div> 
			...
			*/
			...
			else
			{
			 ...
			 ?>
				...
				<div class="call"><img src="<?php echo get_template_directory_uri() ?>/images/landing-call_beacon.png" /></div>
		  </div>
