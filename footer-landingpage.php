...
<div id="footer">
   <center>  
   <div  class="landing-hed" style="margin-top:45px;">  
    ...
    <div class="footer_line"></div> <div class="footer_sub_box2">
      ...
      <div class="footer_sub_text">  
        <ul>
          ...
          <li><a href="<?php echo home_url()?>/about-us/contact-us/branches-agencies">Beacon Locations</a></li>
          <li><a href="<?php echo home_url()?>/about-us/contact-us">Contact us</a></li>
          <li><a href="<?php echo home_url()?>/products-page/faqs/glossary">Beacon FAQ</a></li>
<li>&nbsp;</li>
    ...
    <div class="footer_sub_box3">
      ...
      <tr>
        ...
        <td valign="middle" class="footer_sub_text2"><a href="<?php echo $linkedUrl; ?>" target="_blank">LinkedIn</a></td>
      </tr>
      <tr>
...
<script type="text/javascript">
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-2894919-1']);
