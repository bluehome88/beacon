 ...
 *
 * The showcase template in Beacon consists of a featured posts section using sticky posts,
...
wp_enqueue_script( 'beacon-showcase', get_template_directory_uri() . '/js/showcase.js', array( 'jquery' ), '2011-04-28' );
		...
		<div id="primary" class="showcase">
			<div id="content" role="main">
				...
				<div class="featured-posts">
					<h1 class="showcase-heading"><?php _e( 'Featured Post', 'beacon' ); ?></h1>
					...
					<section class="featured-post <?php echo $feature_class; ?>" id="featured-post-<?php echo $counter_slider; ?>">
						...
						<?php
							...
							if ( has_post_thumbnail() ) {
								...
								?>
								<a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'beacon' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_post_thumbnail( $thumbnail_size ); ?></a>
								<?php
							}
						?>
					...
					<?php
				    	...
				    	while ( $featured->have_posts() ) : $featured->the_post();
							...
							if ( 1 == $counter_slider )
								...
								$class = '';
				    	?>
						<li><a href="#featured-post-<?php echo $counter_slider; ?>" title="<?php printf( esc_attr__( 'Featuring: %s', 'beacon' ), the_title_attribute( 'echo=0' ) ); ?>" <?php echo $class; ?>></a></li>
					<?php endwhile;	?>
					</ul>
				</nav>
				...
				<section class="recent-posts">
					<h1 class="showcase-heading"><?php _e( 'Recent Posts', 'beacon' ); ?></h1>
					...
					while ( $recent->have_posts() ) : $recent->the_post(); ?>
						...
						<li class="entry-title">
							<a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'beacon' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_title(); ?></a>
							<span class="comments-link">
								<?php comments_popup_link( '<span class="leave-reply">' . __( 'Leave a reply', 'beacon' ) . '</span>', __( '<b>1</b> Reply', 'beacon' ), __( '<b>%</b> Replies', 'beacon' ) ); ?>
							</span>
						</li>
