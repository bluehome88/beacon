...
if($page_id == 210) 
{
	...
	if(isset($_POST['Submit']) && $_POST['Submit']!="")
	{
		...
		else
		{
			...
			$mail_to="diane.ali@beacon.co.tt";
    ...
    <div class="contain_main_left">
	  ...
	  {  
		   ...
		   <table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>
				<td><div class="northwestbluebg"> <br/><br/><br/> 11 Stanmore Avenue <br /> Port of Spain <br/><br/> Queries:<br/>225 1288/9<br/><br/>Payments and<br/>General Info:<br/>225 1291/2<br/><br/>Fax:<br/>868.627.0387<br/><br/> Email:<br />nwpf@beacon.co.tt   </div></td>
			  </tr>
			</table>
		   </div>

           <style>
           .faq_midle{ width:500px ;}
           </style>
...
<td>
		   ...
		   <table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>
				<td><img src="<?php echo get_template_directory_uri();?>/images/mispage.png" alt="NorthWest" /></td>
			  </tr>
			</table>
		   </div>
</td>
